...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/blurepen.png
  AssetGenImage get blurepen =>
      const AssetGenImage('assets/icons/blurepen.png');
  ...
  List<AssetGenImage> get values =>
      [blurepen, hashtag, icon, microphone, user, w];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/downCatsArrow.png
  AssetGenImage get downCatsArrow =>
      const AssetGenImage('assets/images/downCatsArrow.png');
  ...
  List<dynamic> get values =>
      [downCatsArrow, profile, programming, tech, techbot];
}
